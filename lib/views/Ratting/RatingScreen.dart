      ...
      body:Stack(
        ...
        children: [
          ListView(
           ...
           Padding(
             ...
             child: Container(
                 ...
                 child: Text('How Was The Experience', style: TextStyle(fontWeight:FontWeight.w500, fontSize: 20 ),)),
           ),
              Image.asset('assets/img/RatingImg.PNG', width: 230 , height: 230,),
              Padding(
          ...
          Padding(
              ...
              child: InkWell(
                  onTap: (){
                    Navigator.of(context).pushReplacementNamed('/RattingGuest');
                  },
