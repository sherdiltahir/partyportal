...
class LiveAuctionInterface extends StatefulWidget {
  @override
  _LiveAuctionInterfaceState createState() => _LiveAuctionInterfaceState();
}

class _LiveAuctionInterfaceState extends State<LiveAuctionInterface> {
  double _lowerValue;
  double _upperValue;
  bool check1 = true;
  bool check2 = false;
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(alignment: Alignment.topRight,
                child: GestureDetector(onTap: (){
                  Navigator.of(context).pushReplacementNamed('/LiveAuctionInterface1');
                },    child: Image.asset("assets/Icons/smallstar.png",height: size.width*0.25,width: size.width*0.19)),),
            ),

            Padding(
              padding: const EdgeInsets.only(top: 280,right: 70),
              child: Container(alignment: Alignment.topRight,
                child: GestureDetector(onTap: (){
                  Navigator.of(context).pushReplacementNamed('/LiveAuctionInterface1');
                },    child: Image.asset("assets/Icons/smallstar.png",height: size.width*0.25,width: size.width*0.19)),),
            ...
            Padding(
              ...
              child: Container(alignment: Alignment.topCenter,
                child: GestureDetector(onTap: (){
                  Navigator.of(context).pushReplacementNamed('/LiveAuctionInterface1');
                },    child: Image.asset("assets/Icons/yellow1.png",height: size.width*0.55,width: size.width*0.55)),),
            ),
            ...
            Padding(
              ...
              child: Container(alignment: Alignment.topLeft,
                child: GestureDetector(onTap: (){
                  Navigator.of(context).pushReplacementNamed('/LiveAuctionInterface1');
                },    child: Image.asset("assets/Icons/normalstar.png",height: size.width*0.25,width: size.width*0.19)),),
            ),
            Padding(
